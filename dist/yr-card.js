...
let YrCardEditor = class YrCardEditor extends LitElement {
    setConfig(config) {
        this._config = config;
    }
    get _name() {
...
__decorate([
    property()
], YrCardEditor.prototype, "hass", void 0);
__decorate([
    property()
], YrCardEditor.prototype, "_config", void 0);
__decorate([
    property()
], YrCardEditor.prototype, "_toggle", void 0);
YrCardEditor = __decorate([
    customElement('yr-card-editor')
], YrCardEditor);
...
/* eslint no-console: 0 */
console.info(`%c  YR-CARD %c ${CARD_VERSION} `, 'color: white; font-weight: bold; background: black', 'color: white; font-weight: bold; background: dimgray');
// TODO Name your custom element
let YrCard = class YrCard extends LitElement {
    static async getConfigElement() {
        return document.createElement('yr-card-editor');
    }
    ...
    shouldUpdate(changedProps) {
        ...
        for (const entity of this._config.entities) {
            if (oldHass.states[entity] !== ((_a = this.hass) === null || _a === void 0 ? void 0 : _a.states[entity])) {
                return true;
            }
        }
        return false;
    ...
    updated() {
        ...
        const met = (_a = this.hass) === null || _a === void 0 ? void 0 : _a.states[this._config.entities[1]];
        const nowCast = (_b = met) === null || _b === void 0 ? void 0 : _b.attributes.forecast;
        const element = (_c = this.shadowRoot) === null || _c === void 0 ? void 0 : _c.getElementById('myChart');
        element.innerHTML = '';
    ...
    precipitation(precipitationMinValueString, precipitationMaxvalueString) {
...
__decorate([
    property()
], YrCard.prototype, "hass", void 0);
__decorate([
    property()
], YrCard.prototype, "_config", void 0);
YrCard = __decorate([
